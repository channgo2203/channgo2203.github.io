...
By shifting to a 3.9kHz interrupt rate, your available CPU time between interrupts expands from 200 cycles to an enormous 102,400 cycles ($256 \mu s$ at 400 MHz). Running Welford's method over 512 samples requires only a few thousand cycles.
