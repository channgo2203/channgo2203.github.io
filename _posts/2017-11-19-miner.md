...
We first need to use the __law of total expectation__ to calculate $$\mathbb{E}[X_i]$$. Let $$A$$ be the event that the miner is trapped, then we have $$\mathbb{E}[X_i]=\mathbb{E}[X_i|A]{\cdot}\mathbb{P}(A)$$
