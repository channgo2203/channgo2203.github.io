...
date:       2016-05-22
excerpt:    Given a string s and a list of strings ls. Find a shortest substring of s that contains all strings in a list of strings ls.
...
occurrence of a substring of str1 that contains all strings in lstr. Compare its length 
