...
For this simple program, we can compute manually that this expected value is `1 + 2.|l|`, where `|l|` is the number of elements in the list. The following are some execution sample of `pfind`.
