...
The following implements a simple example of probabilistic program for finding a given value in a list of integer values. The fist function represents the standard program, e.g., without probability. 
